...
namespace BubbaBloxLauncher
{
    public partial class Launcher : Form
    {
        ...
        public Launcher(string placeId, string ticket, string year = "2016", bool Use2020Menu = false)
        {
            ...
            bbexe = Path.Combine(clientlocation, "TBPlayerBeta.exe");
        ...
        private void Init()
        {
            ...
            var logo = new PictureBox
            {
                ...
                Image = Throback.Properties.Resources.bblogo,
            };
        ...
        private async void Start()
        {
            try
            {
                ...
                else if (!FirstRun && !(Needs2018Install))
                {
        ...
        private void Cancel()
        {
            try
            {
                ...
                string bbfolder = Path.Combine(localapppath, "Throback");
        ...
        private async Task DownloadVersion(string version)
        {
            ...
            {
                string ZipURL = "https://cdn.discordapp.com/attachments/1491416666243072111/1491460132322807979/2018.zip?ex=69d7c5fd&is=69d6747d&hm=d2fcf249f78e88669f155daf66d0f87dca8c3110aad61545777fe98549ef0134&";

                string Target = ClientZIP2018;

                string Extract = Client2018Path;
        ...
        private void Launch()
        {
            try
            {
                ...
                this.Refresh();
                // we should make this dynamic in the future, like in the tbclient:// thing should have  the url
                string joinUrl = $"https://thrbck.lol/game/PlaceLauncher.ashx?placeid={placeId}&ticket={ticket}&2018=true";

                string arguments = $"-a \"https://thrbck.lol/Login/Negotiate.ashx\" -j \"{joinUrl}\" -t \"{ticket}\"";
